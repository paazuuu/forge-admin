...
const aiComponentInfoMap: Record<string, AIComponentInfo> = {
  ...
  KpiGroup: { defaultW: 900, defaultH: 112, description: '指标组，适合顶部 2-6 个核心指标整齐排列；dataset 使用 [{title,value,unit,trend}]' },
  ...
  GlowBackdrop: { defaultW: 720, defaultH: 420, description: 'SVG 风格发光背景，含 reactor/grid/wing/stargate/radar 类型，适合铺在图表/地图/标题后方增强科技炫酷氛围，zIndex 建议较低' },
