...
SELECT 1, '编码规则', @code_rule_parent_id, 2, 8, '/app-center/code-rules', 'app-center/code-rules', 0,
       0, NULL, '_self', 0, 1, 1, 'ai:businessObject:code-rules', 'ionicons5:BarcodeOutline',
