...
![应用中心首页](/images/lowcode/app-center-overview.png)
...
![新建业务域](/images/lowcode/create-suite.png)
...
![向导第一步](/images/lowcode/object-wizard-step1.png)
...
![向导第二步](/images/lowcode/object-wizard-step2.png)
...
![向导第三步](/images/lowcode/object-wizard-step3.png)
...
![对象设计器](/images/lowcode/designer-shell.png)
...
![表单设计器](/images/lowcode/form-designer.png)
...
![列表设计](/images/lowcode/list-designer.png)
...
![关系配置](/images/lowcode/relation-designer.png)
...
![记录选择器](/images/lowcode/record-selector.png)
...
![入口向导-选择场景](/images/lowcode/entry-wizard-step1.png)
...
![创建应用入口](/images/lowcode/entry-wizard-step3.png)
...
![流程配置](/images/lowcode/flow-binding.png)
...
![单据配置](/images/lowcode/document-config.png)
...
![自动化动作配置](/images/lowcode/action-designer.png)
...
![详情页配置](/images/lowcode/detail-config.png)
...
![发布检查](/images/lowcode/publish-check.png)
...
![闭环检查](/images/lowcode/closure-check.png)
...
![基础数据准备](/images/lowcode/test-base-data.png)
...
![采购流程测试](/images/lowcode/test-purchase-flow.png)
...
![出库流程测试](/images/lowcode/test-outbound-flow.png)
...
![数量台账验证](/images/lowcode/test-quantity-ledger.png)
